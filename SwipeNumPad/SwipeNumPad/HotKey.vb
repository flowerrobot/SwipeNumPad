...
Public Class HotKey
    ...
    Public Property KeyModifiers() As KeyModifier
        ...
        End Get
        Private Set(value As KeyModifier)
    ...
    Public Property Action() As Action(Of HotKey)
        Get
            Return m_Action
        End Get
        Private Set(value As Action(Of HotKey))
            m_Action = value
        End Set
    End Property
    Private m_Action As Action(Of HotKey)
    ...
    ' ******************************************************************
    Public Sub New(k As Key, keyModifiers__1 As KeyModifier, action__2 As Action(Of HotKey), Optional register__3 As Boolean = True)
        Key = k
